...
all:	$(POP_SOUND) $(TYPE_SOUND) $(RJFC_SOUND) $(SNAP_SOUND)
all:	$(NOW_SOUND) $(MOVE_SOUND) $(MMORE_SOUND) $(CHNGE_SOUND)
all:	$(POP_SOUND_RES) $(TYPE_SOUND_RES) $(RJFC_SOUND_RES)
...
clean:
	...
	@$(RM) $(POP_SOUND) $(TYPE_SOUND) $(RJFC_SOUND) $(SNAP_SOUND)
	@$(RM) $(NOW_SOUND) $(MOVE_SOUND) $(MMORE_SOUND) $(CHNGE_SOUND)
	@$(RM) $(POP_SOUND_RES) $(TYPE_SOUND_RES) $(RJFC_SOUND_RES)
...
$(POP_SOUND) $(TYPE_SOUND) $(RJFC_SOUND) $(SNAP_SOUND): $(SOUND_STR)
$(NOW_SOUND) $(MOVE_SOUND) $(MMORE_SOUND) $(CHNGE_SOUND): $(SOUND_STR)

$(POP_SOUND) $(TYPE_SOUND) $(RJFC_SOUND) $(SNAP_SOUND) $(NOW_SOUND) \
...
$(POP_SOUND_RES) $(TYPE_SOUND_RES) $(RJFC_SOUND_RES) $(SNAP_SOUND_RES) \
